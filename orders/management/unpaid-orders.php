...
$ordersdata = $orders->fetchOrders("where (pg='0' AND status <> '-1') $filteruser order by date desc LIMIT $inicio,$total_reg");
...
';
?>
<form action="unpaid-orders.php" method="GET">
    <div class="row pd-2">
...
echo " <a class='btn red' href='unpaid-orders.php?pagina=$anterior&last=$total_reg&filteruser=".$filteruserall."'><- Anterior</a> ";

  }else{
echo " <a class='btn red' href='unpaid-orders.php?pagina=$anterior&last=$total_reg&filteruser=".$filteruserName."'><- Anterior</a> ";
  }
}else{
...
if ($pc<$tp) {
  if(isset($filteruserall)){
echo " <a class='btn green darken-2' href='unpaid-orders.php?pagina=$proximo&last=$total_reg&filteruser=".$filteruserall."'>Próxima -></a>";

  }else{
echo " <a class='btn green darken-2' href='unpaid-orders.php?pagina=$proximo&last=$total_reg&filteruser=".$filteruserName."'>Próxima -></a>";
  }
}else {
